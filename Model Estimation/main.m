...
% This function is used as a demonstration of FHMM model estimation

function [b,hess,est,FVAL] = main
global n Qd_pre S p Q CCP D AggObserved QFValue
load('data4estimate.mat');
